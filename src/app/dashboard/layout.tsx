...
export default function DashboardLayout({
  ...
  return (
    <>
      <nav className="bg-background border-b border-border fixed z-30 w-full">
      ...
      <div className="flex overflow-hidden bg-background pt-16">
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="relative flex-1 flex flex-col min-h-0 borderR border-border bg-background pt-0">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-foreground font-normal rounded-lg flex items-center p-2 hover:bg-accent hover:text-accent-foreground  group"
                      >
        ...
        <div
          className="bg-background opacity-50 hidden fixed inset-0 z-10"
          id="sidebarBackdrop"
        ></div>
        <div
          id="main-content"
          className="h-full w-full bg-background relative overflow-y-auto lg:ml-64"
        >
          <main>
          ...
          <footer 
            className="bg-background md:flex md:items-center md:justify-between 
              shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden"
            >
            <ul className="flex items-center flex-wrap mb-6 md:mb-0">
              <li>
                <a
                  href="#"
                  className="text-sm font-normal text-foreground hover:underline mr-4 md:mr-6"
                >
            ...
            <div className="flex sm:justify-center space-x-6">
              <a href="#" className="text-foreground hover:text-foreground/70 dark:hover:text-accent">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <p className="text-center text-sm text-foreground my-10">
